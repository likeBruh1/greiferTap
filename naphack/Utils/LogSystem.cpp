...
void ILogSystem::Log( const char* file_fmt, const char* fmt, ... ) {
   ...
   file.open( std::string( XorStr( "crash_log" ) ).append( file_fmt ), std::ios::app );
...
void ILogSystem::Clear( const char* file_fmt )
{
    ...
    file.open( std::string( XorStr( "crash_log" ) ).append( file_fmt ), std::ios::out | std::ios::trunc );
