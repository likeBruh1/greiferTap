...
public:
	...
	void AddCapsuleOverlay( Vector &mins, Vector &maxs, float pillradius, int r, int g, int b, int a, float duration, bool visibleOnly = false ) {
		if( visibleOnly )
			return Memory::VCall<void( __thiscall * )( void *, Vector &, Vector &, float &, int, int, int, int, float )>( this, 24 )( this, mins, maxs, pillradius, r, g, b, a, duration );

		Memory::VCall<void( __thiscall * )( void *, Vector &, Vector &, float &, int, int, int, int, float )>( this, 23 )( this, mins, maxs, pillradius, r, g, b, a, duration );
	}
