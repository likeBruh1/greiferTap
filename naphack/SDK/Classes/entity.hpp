...
//public:
//	CNewParticleEffect *Create( const char *pszParticleName, int iAttachType, int iAttachmentPoint = -1, Vector vecOriginOffset = Vector( 0, 0, 0 ), matrix3x4_t *vecOffsetMatrix = NULL );
//};
...
public:
	...
	void DrawHitboxMatrix( matrix3x4_t *bones, mstudiobbox_t *hitbox = nullptr, float flDuration = 0.f, Color clr = Color( 1, 2, 3 ) );
	CIKContext *&m_pIk( );
	bool Teleported( );
	int &m_iTeamNum( );
