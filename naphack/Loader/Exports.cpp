...
__declspec( dllexport ) patterns_t g_patterns {
	250,
		//pattern_t{ "client.dll", "55 8B EC 8B 45 10 F3 0F 10 81", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? 8B 07 89 46 0C", 0 },
		pattern_t{ "client.dll", "56 8B F1 6A 00 6A 00 C7", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? F3 0F 10 4D ? 83 C4 08 F3 0F 10 45 ? F3 0F 59 C0", 0 },
		pattern_t{ "client.dll", "55 8B EC 83 E4 ? 81 EC ? ? ? ? 53 56 57 8B F9 89 7C 24 ? E8", 0 },
		pattern_t{ "client.dll", "55 8B EC 51 56 57 8B F1 E8 ? ? ? ? 0F B7 8E", 0 },
		...
		pattern_t{ "client.dll", "55 8B EC 83 E4 F8 83 EC 78 56 57 8B 3D", 0 },
		pattern_t{ "client.dll", "FF 50 3C 8B 4C 24 20", 0 },
		pattern_t{ "client.dll", "B8 ? ? ? ? C3 CC CC CC CC CC CC CC CC CC CC 55 8B EC 83 E4 F8 83 EC 20", 0 },
		...
		pattern_t{ "client.dll", "E8 ? ? ? ? 83 C4 10 EB 79", 0 },
		pattern_t{ "client.dll", "55 8B EC 80 7D 08 00 B8 ? ? ? ? 56", 0 },
		pattern_t{ "client.dll", "55 8B EC 8B 4D 08 83 EC 0C 8B 51 08", 0 },
		pattern_t{ "client.dll", "0F 10 05 ? ? ? ? 8D 85 ? ? ? ? B9", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? 8D A5 ? ? ? ? 5F 5E 5B 8B E5 5D C2 04 00 8B 35", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? 80 BE ? ? ? ? ? 0F 84 ? ? ? ? 83 BE ? ? ? ? ? 0F 84 ? ? ? ? B8", 0 },
		pattern_t{ "client.dll", "84 C0 74 17 8B 87", 0 },
		...
		//pattern_t{ "client.dll", "84 C0 75 05 B0 01 5F", 0 },
		...
		pattern_t{ "client.dll", "E8 ? ? ? ? 8B 06 8B CE FF 90 ? ? ? ? 85 C0 74 4E", 0 },
		...
		pattern_t{ "client.dll", "56 57 FF 52 18", 0 },
		...
		pattern_t{ "client.dll", "55 8B EC 83 7D 08 FF 56 8B F1 74 3D", 0 },
		...
		pattern_t{ "client.dll", "55 8B EC 83 E4 F0 81 EC ? ? ? ? 56 57 8B F9 8B 0D ? ? ? ? 89 7C 24 28 8B", 0 },
		...
		pattern_t{ "client.dll", "55 8B EC 83 EC 78 57", 0 },
		pattern_t{ "client.dll", "55 8B EC 83 E4 F8 83 EC 0C 53 56 8B F1 57 83 BE", 0 },
		pattern_t{ "client.dll", "55 8B EC 56 8B F1 E8 ? ? ? ? 8B 8E", 0 },
		pattern_t{ "client.dll", "FF D0 A1 ? ? ? ? ? ? ? ? B9 ? ? ? ? ? ? ? ? D9 1D ? ? ? ? ? ? ? ? FF 50 34 85 C0 74 22 8B 0D", 0 },
		pattern_t{ "client.dll", "55 8B EC 83 E4 F8 83 EC 0C 53 56 8B F1 8B 86", 0 },
		pattern_t{ "client.dll", "55 8B EC 83 EC 10 53 8B 5D 08 57 8B F9", 0 },
		pattern_t{ "client.dll", "55 8B EC 83 E4 ? 83 EC ? 53 8B D9 56 57 8B 03 FF 90 ? ? ? ? 8B F8 89 7C 24 ? 85 FF 0F 84 ? ? ? ? 8B 17 8B CF", 0 },
		pattern_t{ "client.dll", "55 8B EC 53 8B 5D 08 56 57 FF 75 18 8B F1", 0 },
		pattern_t{ "client.dll", "0F 11 05 ? ? ? ? 0F 10 87", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? 8B 4C 24 14 85 C0", 0 },
		pattern_t{ "client.dll", "8D 8F ? ? ? ? F3 0F 10 84 24", 0 },
		pattern_t{ "client.dll", "8D 9A ? ? ? ? 89 45 9C", 0 },
		pattern_t{ "client.dll", "C6 05 ? ? ? ? ? 88 81 ? ? ? ? F3 0F 10 4E", 0 },
		pattern_t{ "client.dll", "56 8B F1 8B 8E ? ? ? ? 83 F9 FF 74 21", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? F3 0F 10 47 ? 0F 2E 45 D8", 0 },
		pattern_t{ "client.dll", "55 8B EC 51 A1 ? ? ? ? 53 56 8B D9", 0 },
		...
		pattern_t{ "client.dll", "E8 ? ? ? ? 8B CF E8 ? ? ? ? 8B 06", 0 },
		...
		pattern_t{ "client.dll", "55 8B EC 83 E4 F8 51 53 56 8B 75 08 8B D9 57 56 E8 ? ? ? ? 85 F6", 0 },
		pattern_t{ "client.dll", "A3 ? ? ? ? 57 8B CB", 0 },

		pattern_t{ "client.dll", "E8 ? ? ? ? 5E 5D C2 10 00 32 C0", 0 },
		pattern_t{ "client.dll", "55 8B EC 83 E4 F8 81 EC ? ? ? ? 53 56 8B F1 57 89 74 24 1C", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? 80 BE ? ? ? ? ? 74 28", 0 },
		pattern_t{ "client.dll", "53 8B DC 83 EC 08 83 E4 F8 83 C4 04 55 8B 6B 04 89 6C 24 04 8B EC 83 EC 18 56 57 8B 7B", 0 },


		pattern_t{ "client.dll", "55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89", 0 },
		pattern_t{ "client.dll", "55 8B EC 51 33 C0 C7 45", 0 },

		pattern_t{ "client.dll", "84 C0 75 0D F6 87", 0 },
		pattern_t{ "client.dll", "FF D0 A1 ? ? ? ? B9 ? ? ? ? D9 1D ? ? ? ? FF 50 34 85 C0 74 22 8B 0D", 0 },
		pattern_t{ "client.dll", "55 8B EC 57 8B F9 8B 97 ? ? ? ? 85 D2", 0 },
		pattern_t{ "client.dll", "E8 ? ? ? ? 8B 47 60 83 B8", 0 },


		pattern_t{ "engine.dll", "E8 ? ? ? ? FF 76 60", 0 },
		pattern_t{ "engine.dll", "03 05 ? ? ? ? 83 CF 10", 0 },
		pattern_t{ "engine.dll", "8B 1D ? ? ? ? 85 C0 74 16 FF B6", 0 },
		pattern_t{ "engine.dll", "85 C0 74 12 53 FF 75 0C 68 ? ? ? ? FF 15 ? ? ? ? 83 C4 0C", 0 },
		...
		pattern_t{ "engine.dll", "55 8B EC 83 E4 C0 81 EC ? ? ? ? 53 56 8B D9", 0 },
		pattern_t{ "engine.dll", "E8 ? ? ? ? 84 DB 0F 84 ? ? ? ? 8B 0D", 0 },
		pattern_t{ "engine.dll", "55 8B EC 81 EC ? ? ? ? 53 56 57 8B 3D ? ? ? ? 8A", 0 },
		pattern_t{ "engine.dll", "E8 ? ? ? ? A1 ? ? ? ? F3 0F 10 0D", 0 },
		...
		pattern_t{ "engine.dll", "56 57 8B F9 8D 4F 08 C7 07 ? ? ? ? E8 ? ? ? ? C7", 0 },
		pattern_t{ "engine.dll", "53 8A D9 8B 0D ? ? ? ? 56 57 8B B9", 0 },
		...
		pattern_t{ "vguimatsurface.dll", "74 1D 8B 0D ? ? ? ? 68", 0 },

		pattern_t{ "vstdlib.dll", "55 8B EC 8B 01 56 FF 75 08 FF 50 3C 8B F0 85 F6 74 1E", 0 },
};
